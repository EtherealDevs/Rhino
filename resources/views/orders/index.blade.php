...
@section('content')
    <div class="container">
        <div class="max-w-7xl h-screen justify-center mx-auto">
            <div class="p-4 w-full bg-white rounded-lg border m-12 shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-xl font-bold leading-none text-gray-900 dark:text-white">Mis Pedidos</h3>
                                ...
                                @foreach ($orders as $order)
                                    <li class="py-3 sm:py-4">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div
                                                class="block items-center text-base font-semibold text-gray-900 dark:text-white">
                                                ${{ $order->total }}
                                                <br>
                                                <time
