                ...
                <div class="bg-black rounded-xl mx-3 mt-3 mb-3 p-3">
                    ...
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <div class="text-sm text-slate-500">
                            ...
                            <select name="size" wire:model.change='size_id' id="" class="block py-2.5 px-6 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
                        ...
                        <input type="text" class="hidden" name="items[]" value="[{{$productItem->id}}, {{$size_id}}]">
