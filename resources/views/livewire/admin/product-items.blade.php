    ...
    <tr>
        ...
        <td class="p-4 relative grid grid-rows-3 gap-2 border-t border-gray-200">
            @if ($productItem->sale)
                ...
                <div
                    class="row-span-1 border-b border-green-300 text-gray-600 text-md font-medium font-josefin rounded-lg px-2 py-1">
                    {{ $productItem->sale->sale->discount }}% de descuento
                </div>
        ...
        <td>
            @foreach ($productItemVariations as $productItemVariation)
                <table>
                    <th>Talle</th>
                    <th>Stock</th>
                    <th>Acciones</th>
                    <tr>
                        <td class="p-4 border-b border-blue-gray-50">
                            <p
                                ...
                                {{ $productItemVariation->size->name }}
                            </p>
                        </td>
                        <td class="p-4 border-b border-blue-gray-50">
                            <div class="w-max">
                        ...
                        <td>
                            <div class="inline-flex items-center rounded-md shadow-sm">
                                <a href="{{ route('admin.productitems.edit', $productItemVariation->id) }}">
                                    <button
                                ...
                                <button
                                    ...
                                    data-modal-target="default-modal-{{ $productItemVariation->id }}"
                                    data-modal-toggle="default-modal-{{ $productItemVariation->id }}">
                                    <span>
                                ...
                                <form action="{{ route('admin.productitems.destroy', $productItemVariation->id) }}"
                                    method="POST">
                                    <div id="default-modal-{{ $productItemVariation->id }}" tabindex="-1"
                                        aria-hidden="true"
                                            ...
                                            <div class="">
                                                ...
                                                <div class="text-center p-5 flex-auto justify-center">
                                                    ...
                                                    <h2 class="text-xl font-bold py-4 ">¿ESTA SEGURO?</h3>
                                                        <p class="text-sm text-gray-500 px-8">¿De verdad quiere borrar
                                                            producto
                                                            id:{{ $productItemVariation->id }}?
                                                            Este proceso no tiene retorno</p>
                                                </div>
                                                <!--footer-->
                                                <div class="p-3  mt-2 text-center space-x-4 md:block">
                                                    <button
                                                        data-modal-hide="default-modal-{{ $productItemVariation->id }}"
                                                        type="button"
