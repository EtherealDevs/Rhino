                    ...
                    <tr>
                        ...
                        <td>
                            <div class="inline-flex items-center rounded-md shadow-sm">
                                ...
                                <form action="{{route('admin.productitems.destroy', $productItemVariation->id)}}" method="POST">
                                    <div id="default-modal-{{ $productItemVariation->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="p-3  mt-2 text-center space-x-4 md:block">
                                                    <button data-modal-hide="default-modal-{{ $productItemVariation->id }}" type="button"
