        ...
        <td class="p-4 border-b border-blue-gray-50">
            <div class="inline-flex items-center rounded-md shadow-sm">
                ...
                <form action={{ route('admin.productitems.destroy', $productSize->id) }} method="POST">
                    <div id="default-modal-{{$productSize->id}}" tabindex="-1" aria-hidden="true" class="hidden min-w-screen h-screen animated fadeIn faster  fixed  left-0 top-0 flex justify-center items-center inset-0 z-50 outline-none focus:outline-none bg-no-repeat bg-center bg-cover"   id="modal-id">
                    ...
                    <path fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" />
                                         ...
                                         <p class="text-sm text-gray-500 px-8">¿De verdad quiere borrar producto id:{{$productSize->id}}?
                                 Este proceso no tiene retorno</p>
                         </div>
                         <!--footer-->
                         <div class="p-3  mt-2 text-center space-x-4 md:block">
                             <button data-modal-hide="default-modal-{{$productSize->id}}" type="button" class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                                 Cancelar
                             </button>

                                @csrf
                                @method('DELETE')
                                <button data-modal-hide="default-modal-{{$productSize->id}}" type="submit" class="mb-2 md:mb-0 bg-red-500 border border-red-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-full hover:shadow-lg hover:bg-red-600">Eliminar</button>
