...
<li class="py-4 px-4 mb-3 bg-white rounded-lg shadow-lg lg:flex flex-col grid grid-cols-2 sm:flex-row sm:items-center">
    ...
    <div class="flex-1 sm:ml-4 mt-4 sm:mt-0 w-full lg:flex flex-col col-span-2 grid grid-cols-2 sm:flex-row sm:justify-between sm:items-center">
        ...
        <div class="">
            <form method="POST" action="{{ route('cart.removeItem', ['cartItemId' => $cartItemId]) }}"
                ...
                <button type="submit" class="hidden lg:block text-gray-400 hover:text-red-500 text-3xl lg:text-2xl font-bold">
                    &times;
                </button>
            </form>
        </div>
