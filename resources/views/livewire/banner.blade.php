<!-- component -->
<div class="bg-gray-100 z-50 " x-data="{ open: true }">
    <div x-show="open" x-on:click.away="open = true" class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow">
