...
<div class="bg-gray-100 z-50">
    <div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow">
      <div class="container mx-auto px-4 py-2 flex justify-between items-center">
        <p class="text-sm text-gray-700">Inicia Sesion hoy y obten 50% de descuento en todos nuestros productos y acceso a todas nuestras promociones
          Ver Promociones <a href="https://larainfo.com/blogs/create-cookie-consent-design-ui-using-tailwind-css" class="text-blue-500">here</a>.</p>
