    ...
    <div x-show="open" x-on:click.away="open = true"
        ...
        <div class="container mx-auto px-4 py-2 flex justify-between items-center">
            ...
            <div class="flex space-x-2 ">
                ...
                <a href="/products">
                    <button
                    class="font-bold px-4 rounded-xl py-1.5 bg-blue-500 text-white hover:bg-blue-600 transition duration-300 ease-in-out">Ver Productos</button>
                </a>
                @else
                <a href="{{ route('login') }}">
                    <button
                    class="font-bold px-4 rounded-xl py-1.5 bg-blue-500 text-white hover:bg-blue-600 transition duration-300 ease-in-out">Iniciar Sesion</button>
                </a>
                @endauth
