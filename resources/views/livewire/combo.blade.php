<div class="gap-6 bg-white grid-rows-3 rounded-xl shadow-md transition-transform pb-4 duration-300 hover:scale-105">
    <div class="grid grid-cols-3 row-span-2">
        ...
        <div class="relative z-10 w-44 lg:w-56 mt-1 flex-col bg-clip-border text-gray-700 px-4">
            <div class="relative mx-3 mt-3 h-24 overflow-hidden rounded-2xl bg-white bg-clip-border text-gray-700">
                <img src="https://images.unsplash.com/photo-1721332154191-ba5f1534266e?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    class="product-image h-full w-full object-cover" />
            </div>
            <div class="flex relative justify-center mt-6 my-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="1em" viewBox="0 0 32 32">
                    <path fill="black"
                        d="M19.05 5.06c0-1.68-1.37-3.06-3.06-3.06s-3.07 1.38-3.06 3.06v7.87H5.06C3.38 12.93 2 14.3 2 15.99c0 1.68 1.38 3.06 3.06 3.06h7.87v7.86c0 1.68 1.37 3.06 3.06 3.06c1.68 0 3.06-1.37 3.06-3.06v-7.86h7.86c1.68 0 3.06-1.37 3.06-3.06c0-1.68-1.37-3.06-3.06-3.06h-7.86z" />
                </svg>
