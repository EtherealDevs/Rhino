<div class="gap-6 bg-white grid-rows-3 rounded-xl shadow-md transition-transform pb-4 duration-300 hover:scale-105">
    <div class="grid grid-cols-5 row-span-2">
        <div class="relative z-10 col-span-2 flex w-44 lg:w-56 mt-1 flex-col bg-clip-border text-gray-700">
        ...
        <div class="justify-center w-1/2 col-span-1">
            ...
            {{-- <div class="flex relative bottom-2">
                    ...
                    <a href="">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="block font-sans text-sm font-light leading-relaxed text-white antialiased text-center">
                                ...
                                </button> <span class="font-bold"> → </span>
                            </p>
                        </div>
                    </a>
                </div>
    ...
    <div class="grid grid-cols-5">
        ...
        <div class="flex col-span-2 bg-black h-20 row-span-1 rounded-xl mx-3 mt-3 p-3">
            <a class="left-1/2" href="">
                    ...
                    <a href="{{route('combos.show', $item->combo)}}" class="block font-sans text-sm font-light leading-relaxed text-white antialiased text-center mt-2">
                        Agregar a carrito
                    </a>
                </div>
            </a>
