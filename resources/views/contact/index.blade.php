            ...
            <div class="grid grid-cols-2">
                <div class="col-span-1 mr-4">
                    <div class="w-full mb-4 flex justify-end">
                        <p class="font-bold text-gray-600 text-md font-josefin">Av. Rio Juramento</p>
                        <svg width="26" height="21" viewBox="0 0 31 27" fill="none"
                    ...
                    <div class="w-full mb-4 flex justify-end">
                        <p class="font-bold text-gray-600 text-md font-josefin">+54 9 379 479 8404</p>
