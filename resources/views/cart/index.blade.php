...
@section('content')
    <!-- component -->
    <div class="w-full h-3/4  bg-gradient-to-r from-gray-50 to-blue-100 via-gray-100 top-0 overflow-x-hidden" id="chec-div">
        <div class="w-full absolute right-0 overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700"
            ...
            <div class="flex items-end lg:flex-row flex-col justify-end mr-10 mt-10" id="cart">
                <div
                    ...
                    <div class="flex flex-col h-3/4 rounded-lg lg:px-8 md:px-7 px-4 lg:py-20 md:py-10 py-6 justify-between ">
