                    ...
                    <div class="col-span-2 flex rounded-br-3xl mt-10">
                        ...
                        <div class="max-w-7xl w-full mr-10 justify-end">
                            ...
                            <div id="default-carousel" class="relative" data-carousel="active">
                                <!-- Carousel wrapper -->
                                <div class="overflow-hidden relative h-9 rounded-lg sm:h-64 xl:h-96 2xl:h-96">
                                    <!-- Item 1 -->
            ...
            <div
                ...
                <div class="bg-black/30 w-full h-full rounded-3xl">
                    ...
                    <div class="flex justify-start p-4 mb-12">
                        <p class="text-center mt-6 text-lg mx-8">
                            Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit
                            laboriosam,
                            nisi ut al Ut enim ad minima veniam.
                        </p>
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <div class="h-full bg-cover bg-center block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                                        ...
                                        <div
                                            ...
                                            <div class="">
                                                <div
                                                    class="grid mt-24 justify-center w-full space-x-4 grid-cols-1 md:flex md:grid-cols-none">
