...
@section('content')
    <div class="p-6">
        <div class="pt-16  ">
            <div class="p-6 rounded-xl bg-white grid grid-cols-2">
                            ...
                            <div class="mb-6 pt-4">
                                <div class="mb-5 rounded-md bg-white py-4 px-8">
                                    <div class="flex items-center justify-between">
                                        <input class="truncate pr-3 text-base font-medium text-[#07074D]">
                                ...
                                <div class="mb-8">
                                    ...
                                    <label for="file"
                                        class="relative flex min-h-52 items-center justify-center rounded-md border border-dashed border-[#e0e0e0] p-12 text-center">
                                        <div>
