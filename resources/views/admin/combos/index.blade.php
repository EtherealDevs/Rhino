                            ...
                            <td class="p-4 border-b border-blue-gray-50">
                                <div class="inline-flex items-center rounded-md shadow-sm">
                                    ...
                                    <button
                                        ...
                                        data-modal-target="default-modal-{{ $combo->id }}"
                                        data-modal-toggle="default-modal-{{ $combo->id }}">
                                        <span>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="p-4 text-center">
                                <p
                                    class="block antialiased font-san py-12 text-sm leading-normal text-blue-gray-900 font-normal">
