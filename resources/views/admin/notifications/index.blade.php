                            ...
                            <div class="relative">
                                <div class="md:flex items-center md:space-x-4 mb-3">
                                    <div class="flex items-center space-x-4 md:space-x-2 md:space-x-reverse">
                                        ...
                                        <!-- Date -->
                                        <time class="text-sm font-medium text-indigo-500 md:w-28">{{date_format($notify->created_at,'j M o')}}</time>
                                    </div>
                                    <!-- Title -->
                                    <div class="text-slate-500 ml-14"><span class="text-slate-900 font-bold">{{$user->name}}</span> opened the request</div>
                                </div>
                                <!-- Card -->
                                <div class="bg-white p-4 rounded border border-slate-200 text-slate-500 shadow ml-14 md:ml-44">{{$cart->contents}}</div>
                            </div>
