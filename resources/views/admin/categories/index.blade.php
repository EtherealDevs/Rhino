                                            ...
                                            <div class="grid grid-cols-2 gap-4 items-center">
                                                ...
                                                <div class="col-span-1">
                                                    <a href="{{ route('admin.categories.edit', $category) }}">
                                                        <button
                                                            class="w-full text-gray-800 hover:text-blue-600 bg-white hover:bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 flex items-center justify-center transition-all duration-200 ease-in-out shadow">
                                                            <span class="mr-2">
                                                ...
                                                <div class="col-span-1">
                                                    <button
                                                        class="w-full text-gray-800 hover:text-red-600 bg-white hover:bg-slate-100 border border-slate-200 rounded-lg px-3 py-1.5 flex items-center justify-center transition-all duration-200 ease-in-out shadow"
