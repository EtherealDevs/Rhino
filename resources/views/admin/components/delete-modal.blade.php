            ...
            <div class="">
                ...
                <div class="text-center p-5 flex-auto justify-center">
                    ...
                    <h2 class="text-xl font-bold py-4 ">¿ESTA SEGURO?</h3>
                        <p class="text-sm text-gray-500 px-8">¿De verdad quiere borrar {{ $name }}
                            id:{{ $item->id }}?
                            Este proceso no tiene retorno</p>
                </div>
                <!--footer-->
                <div class="p-3  mt-2 text-center space-x-4 md:block">
                    <button data-modal-hide="default-modal-{{ $item->id }}" type="button"
                    ...
                    @csrf
                    @method('DELETE')
                    <button data-modal-hide="default-modal-{{ $item->id }}" type="submit"
