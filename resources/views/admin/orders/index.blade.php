...
@section('content')
    ...
    <script src="//unpkg.com/alpinejs" defer></script>
        ...
        <div
            class="mb-3 mt-24 flex w-full max-w-screen-xl transform cursor-pointer flex-col justify-between rounded-md bg-white bg-opacity-75 p-6 text-slate-800 transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-lg dark:bg-white dark:bg-opacity-25 dark:text-slate-300 lg:flex-row lg:p-4">
            <div class="flex w-full flex-row lg:w-3/12">
                <div class="relative flex flex-col">
                    <div
                        ...
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&w=128&h=128&q=60&facepad=1.5"
                            class="z-10 h-12 w-12 rounded-full object-cover shadow hover:shadow-xl" alt="Rocky Balboa" />
                ...
                <div class="ml-4 self-center overflow-x-hidden">
                    <div class="w-full text-gray-700 truncate text-xl font-extrabold leading-5 tracking-tight">Rocky Balboa</div>
            ...
            <div class="z-50 hidden w-1/6 self-center lg:block">
                <div class="flex flex-row justify-center">
                    <div x-data="{ tooltip: false }"
                        class="relative z-0 -mr-4 inline-flex transition duration-300 ease-in-out hover:-mr-1" x-cloak>
                        ...
                        <div class="relative z-50 overflow-visible pt-2" x-cloak x-show="tooltip"
                            ...
                            <div
                                ...
                                <div class="text-slate-700 dark:text-slate-200 text-center text-base font-extrabold">Marilyn
                                    Monroe</div>
                    ...
                    <div x-data="{ tooltip: false }" class="relative z-0 -mr-4 inline-flex transition duration-300 ease-in-out"
                        x-cloak>
                        <img @mouseover="tooltip = true" @mouseleave="tooltip = false"
                            class="z-10 h-9 w-9 rounded-full border-2 border-white object-cover shadow hover:shadow-xl dark:border-slate-800"
                        ...
                        <div class="relative z-50 overflow-visible pt-2" x-cloak x-show="tooltip"
                            ...
                            <div
                                class="absolute -right-1 z-50 mt-1 w-40 -translate-x-10 -translate-y-5 transform overflow-x-hidden rounded-lg bg-blue-200 p-2 text-center leading-tight text-white shadow-md dark:bg-slate-900">
                                <div class="text-slate-700 dark:text-slate-200 text-center text-base font-extrabold">Jimmy
                                    Stewart</div>
