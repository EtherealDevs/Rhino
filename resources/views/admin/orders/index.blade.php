...
@section('content')
    <div class="">
        ...
        <table class="border-b-2 border-gray-200 ">
            <thead class="border-b-2 border-gray-200 ">
                <th class="antialiased font-sans text-lg text-blue-gray-900 font-normal leading-none opacity-70">Nro</th>
                <th class="antialiased font-sans text-lg text-blue-gray-900 font-normal leading-none opacity-70">Usuario</th>
                <th class="antialiased font-sans text-lg text-blue-gray-900 font-normal leading-none opacity-70">Ciudad</th>
                <th class="antialiased font-sans text-lg text-blue-gray-900 font-normal leading-none opacity-70">Productos
                </th>
                <th class="antialiased font-sans text-lg text-blue-gray-900 font-normal leading-none opacity-70">Monto</th>
            </thead>
            <tbody>
                <tr>
                    <div
