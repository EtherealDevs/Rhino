<x-guest-layout>
    ...
    <div class="mt-32 lg:mt-4 relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
        <div class="flex-col flex self-center lg:px-8 sm:max-w-4xl xl:max-w-md z-10">
            <div class="self-start hidden lg:flex flex-col text-gray-300">
                ...
                <p class="pr-3 text-lg opacity-75">Nos alegra verte de nuevo en Rino. Inicia sesión para acceder a todas
