...
@section('content')
    <section>
            ...
            <div class="w-screen h-2/6">
                ...
                <div class="-translate-y-full w-full grid grid-cols-8 justify-between p-14 overflow-x-hidden">
                    <div class="mx-auto col-span-8 relative">
                        ...
                        <div class="grid grid-cols-2 lg:grid-cols-5 mb-12 mt-3 relative">
        ...
        <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-20 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-30rem)]"
            aria-hidden="true">
